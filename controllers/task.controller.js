...
export const getTasksByUser = async (req, res, next) => {
    try {
        ...
        const validOrderByFields = ['name', 'priority', 'status', 'due', 'createdAt'];
        const sort = validOrderByFields.includes(orderBy) ? { [orderBy]: 1 } : {};
        ...
        const taskCount = await collection.countDocuments(query); // �������� � count �� countDocuments
